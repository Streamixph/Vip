...
def user_pays(call):
    ...
    markup.add(InlineKeyboardButton("📞 Contact Streamixph", url=f"https://t.me/{CONTACT_USERNAME}"))
...
def kick_expired_users():
    ...
    for user in expired_users:
        try:
            ...
            bot.send_message(user['user_id'], "⚠️ Ka Streamixph Your subscription has expired.\n\nTo join again or renew, please click the button below:", reply_markup=markup)
